...
- **Data-pack passphrase unlock**: third-party packs can hide entries behind passphrase groups; users unlock them from Data Pack Manager or `Shift + K + L`. GM maker can edit passphrase groups and assign item/spell/trait visibility. This is UI visibility gating, not strong cryptographic encryption.
