...
export const LEVEL_2_SPELLS: SpellDefinition[] = [
  ...
  // ==========================================
  {
    ...
    target: '30尺内至多3个生物',
    attackType: 'none',
    description: '<p>你的法术给予你的盟友坚韧与决心。选择射程内至多三个生物。在法术持续期间，每个目标的生命值上限和当前生命值都增加 5 点。</p>',
    scaling: '当你使用 3 环或更高环阶的法术位施展此法术时，每比 2 环高一环，目标的生命值增加量就额外增加 5 点。',
  ...
  },
  {
    ...
    castingTime: '1 动作',
    range: '触及',
    components: { v: true, s: true, m: '价值至少 25gp 的金粉，法术会消耗掉' },
    concentration: false,
    duration: '直到被解除',
    target: '一扇门、窗或容器',
    attackType: 'none',
    description: '<p>你触碰一扇关闭的门、窗、大门、箱子或其他通道入口，使其在法术持续时间内被魔法锁住。你和你在施法时指定的生物可以正常打开该物体。你还可以设定一个口令，当在物体 5 尺内说出口令时，该法术会被压制 1 分钟。</p><p>除此之外，该物体不可通行，直到它被破坏，或者法术被解除或压制。对该物体施展<i>敲击术 (Knock)</i> 可以压制奥术锁 10 分钟。</p><p>受术期间，该物体更难被破坏或强行打开；破坏它所需的力量检定 DC 以及撬锁所需的敏捷检定 DC 均增加 10。</p>',
    scaling: '无',
  ...
  },
  {
    ...
    target: '一个生物',
    attackType: 'none',
    description: '<p>你触碰一个生物，并可以结束一种影响着该生物的疾病或状态。该状态必须是目盲、耳聋、麻痹或中毒。</p>', // 原文如此，这里的描述其实没问题，保持现状
    scaling: '无',
  ...
  },
  {
    ...
    target: '自身(30尺半径)',
    attackType: 'none',
    description: '<p>阴影与寂静之幕从你身上散发出来，将你和你的同伴行踪隐藏起来。在法术持续期间，你周围 30 尺内你选择的每个生物（包括你）在敏捷（隐匿）检定中具有 +10 加值，且除非使用魔法手段，否则无法被追踪。受此法术影响的生物经过之后不会留下足迹或其他痕迹。</p>',
    scaling: '无',
  ...
  },
  {
    ...
    target: '召唤一只精魂坐骑',
    attackType: 'none',
    description: '<p>你召唤一个精魂，它化身为一种异常聪明、强壮且忠诚的坐骑，并与你建立长久的羁绊。坐骑出现在射程内一处未被占据的空间，形态由你选择：战马、矮种马、骆驼、麋鹿或獒犬（或其他 DM 允许的动物）。该坐骑拥有对应形态的数据，但其生物类型是天界、精类或邪魔（由你选择）。如果你的坐骑智力为 5 或更低，它的智力变为 6，并获得理解一种你所说语言的能力。</p><p>坐骑在你的回合中作为受控坐骑行动。它拥有该形态生物的正常动作。当你骑乘时，你施展任何只以你自己为目标的法术时，也可以同时以该坐骑为目标。</p><p>当坐骑的生命值降至 0 时，它消失，不留下任何物理躯体。你也可以随时使用一个动作解消它，使其消失。若你再次施展此法术，你会召唤回同一匹坐骑，并使其恢复至生命值上限及全盛状态。</p>',
    scaling: '无',
    classes: ['paladin'],
    cantripScaling: false
  },
