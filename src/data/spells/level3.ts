...
export const LEVEL_3_SPELLS: SpellDefinition[] = [
  ...
  },
  {
    ...
    target: '一个正在施法的生物',
    attackType: 'none',
    description: '<p>你试图打断一个正在施法的生物。如果该生物正在施展 3 环或更低环阶的法术，则该法术失败且无任何效果。如果它正在施展 4 环或更高环阶的法术，你需要进行一次施法关键属性检定。DC 等于 10 + 该法术的环阶。若检定成功，该法术失败且无任何效果。</p>',
    scaling: '4环及以上(若目标法术环阶不高于你使用的法术位环阶，则自动成功)',
  ...
  // ==========================================
  {
    ...
    castingTime: '10 分钟',
    range: '1 英里',
    components: { v: true, s: true, m: '价值至少100gp的器材（听觉需镶宝石的号角，视觉需玻璃眼球）' },
    concentration: true,
    duration: '10 分钟',
    target: '创造一个隐形传感器',
    attackType: 'none',
    description: '<p>你在射程内一个你熟悉的地点（你曾去过或见过的地方）或一个明显的陌生地点（如门后、转角处或树丛中）创造一个隐形的魔法传感器。传感器在法术持续期间保持在原位，无法被攻击或互动。</p><p>施法时，你选择视觉或听觉。你可以通过该传感器使用选定的感官，如同你位于该位置一样。作为动作，你可以在视觉和听觉之间切换。</p><p>能看见隐形物体的生物（如拥有<i>识破隐形</i>或<i>真实视觉</i>）会看到传感器是一个拳头大小的发光、无实体球体。</p>',
    scaling: '无',
  ...
  },
  {
    ...
    target: '60尺半径球状区域',
    attackType: 'none',
    description: '<p>一个 60 尺半径的光球从射程内你选择的一点扩散开来。球内充满明亮光照，并向外延伸额外 60 尺微暗光照。</p><p>如果你选择的点在一个你持握或未被穿戴携带的物体上，光照将从该物体发出并随其移动。若用不透明物体完全遮盖光源，光照被阻挡。</p><p>若此法术区域覆盖了 3 环或更低环阶法术制造的黑暗区域，制造黑暗的法术被解除。</p>',
    scaling: '无',
